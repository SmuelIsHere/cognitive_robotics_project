...
(cl:defmethod cl:initialize-instance :after ((m <WakeUp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WakeUp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name progetto-srv:<WakeUp-request> is deprecated: use progetto-srv:WakeUp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <WakeUp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WakeUp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name progetto-srv:<WakeUp-response> is deprecated: use progetto-srv:WakeUp-response instead.")))
