...
class Text2SpeechNode:
    ...
    def __init__(self, ip, port):
        ...
        self.tts_default = self.session.get_service("ALTextToSpeech")
        self.tts = self.session.get_service("ALAnimatedSpeech")
        self.tts_default.setLanguage("Italian")
        # il parametro 2 significa body language contestuale a ciò che dice
